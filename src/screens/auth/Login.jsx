...
import { clearLogin, loginApi } from '../../app/features/auth/loginSlice'
...
const Login = () => {
  ...
  const { message, success, isLoading, errorMessage, isError } = useSelector((value) => value.login)
      ...
      <div className="xl:w-1/2 sm:w-8/12 xsm:w-full h-screen xl:px-24 lg:px-0 xsm:px-0 xsm:pl-6 xl:mx-12 lg:mx-auto xsm:mx-auto animate-auth-div">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row justify-between pr-6 relative">
            ...
            <div className="text-[#5429FF] sm:text-[16px] xsm:text-[12px] font-medium">
